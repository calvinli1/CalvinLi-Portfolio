  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-lg": "0 0 40px rgba(30, 144, 255, 0.6)",
        "glow-lime": "0 0 20px rgba(57, 255, 20, 0.5)",
        "elevated-white": "0 0 30px rgba(255, 255, 255, 0.15)",
      },
      fontFamily: {
      ...
      backgroundImage: {
        "cyber-gradient": "linear-gradient(135deg, #000000 0%, #121212 100%)",
        "electric-gradient": "linear-gradient(90deg, #1E90FF, #39FF14)",
      },
    },
  },
